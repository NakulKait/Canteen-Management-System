...
import "./AboutUs.css"; // Add slide effect here
      ...
      >
        <div className="bg-white shadow p-5 rounded w-100 h-100" style={{ overflowY: "auto" }}>
          ...
          <p className="text-muted fs-5">
            Welcome to the <strong>Canteen Management System</strong>! Our goal is to provide a
            seamless digital platform for managing food services within campuses or corporate spaces.
          </p>
          ...
          <p className="text-muted fs-5">
            To simplify and enhance the canteen experience for customers and staff by leveraging
            modern technology.
          </p>
